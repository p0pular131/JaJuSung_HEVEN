...
double GPS_STANLEY::find_angle_error(double car_angle, std::pair<double,double> position_curr, std::pair<double,double> position_targ)
{
    ...
    double target_angle = rad2deg(atan(targetdir_y/targetdir_x));
