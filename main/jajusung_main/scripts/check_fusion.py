...
[[ 0.1021146,  -0.99476038, -0.00493989, -0.18844431],
 [-0.16365577, -0.01190107, -0.98644572,  0.32667845],
 [ 0.98121832,  0.10153895, -0.16401355,  0.49674831]]
                            )
...
class Fusion():
    ...
    def lidar_callback(self, data):
        ...
        # cloud = do_voxel_grid_downssampling(cloud, 0.4)
        # ROI
        filter_axis = 'z'
        axis_min = -1.0
        axis_max = 1.7
